...
mod tests {
    ...
    impl TaskPersistence for MockTaskPersistence {
        async fn execute_delegation_command(
            ...
            unreachable!("approval fixture does not execute delegation controls")
        }
        ...
        async fn outreach_reassignment_context(
            ...
            unreachable!("approval fixture does not reassign delegation targets")
        }
        ...
        async fn ask_owner_to_act(
            ...
            Err(AppError::Internal(
                "agent instructions are not used by this approval double".into(),
            ))
        }
        ...
        async fn start_agent_task(
            ...
            Err(AppError::Internal(
                "agent task starts are not used by this approval double".into(),
            ))
        }
