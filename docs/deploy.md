...
| `TASK_OWNERSHIP_CONTROLS_ENABLED` | Enables ownership mutations and human-owner completion; `true` or `false`, default `false`. Workers enforce ownership fences in either state. |
